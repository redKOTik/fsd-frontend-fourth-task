...
## Приступая к работе
  ...
  **value()**
  ...
  #### Список событий
  `valueChanged (event, value)` - изменено состояние слайдера.
...
Этот проект лицензируется в соответствии с лицензией MIT — подробности см. в файле [LICENSE](./LICENSE.md)
